...
* Does not block the build — report is informational at this stage (enforcement is MGG-124)

## Notes

* Requires MGG-122 (.NET collection) and MGG-126 (Vitest setup) to be in place
