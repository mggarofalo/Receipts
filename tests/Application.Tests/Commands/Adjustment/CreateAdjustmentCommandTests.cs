...
public class CreateAdjustmentCommandTests : ICommandTests<Domain.Core.Adjustment>
{
	[Fact]
...
#pragma warning disable CS8604 // Possible null reference argument.
		Assert.Throws<ArgumentNullException>(() => new CreateAdjustmentCommand(items, Guid.NewGuid()));
#pragma warning restore CS8604 // Possible null reference argument.
	...
	public void Command_WithEmptyItems_ThrowsArgumentException()
	{
		...
		Assert.Throws<ArgumentException>(() => new CreateAdjustmentCommand(items, Guid.NewGuid()));
	}
	...
	public void Command_WithValidItems_ReturnsValidCommand()
	{
		...
		CreateAdjustmentCommand command = new(items, receiptId);
	...
	{
		List<Domain.Core.Adjustment> items = AdjustmentGenerator.GenerateList(2);
		CreateAdjustmentCommand command = new(items, Guid.NewGuid());
