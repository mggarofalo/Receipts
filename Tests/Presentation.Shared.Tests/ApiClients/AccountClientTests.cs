...
public class AccountClientTests
{
	...
	[Fact]
	public void NoArgsConstructor_ShouldInitializeAccountClient()
	{
		// Act
		AccountClient accountClient = new();

		// Assert
		Assert.NotNull(accountClient);
	}
	...
	public async Task CreateAccounts_ShouldReturnCreatedAccounts()
	{
		...
		// Act
		List<AccountVM>? result = await _accountClient.CreateAccountsAsync(accounts);
	...
	public async Task GetAccountById_ShouldReturnAccount()
	{
		...
		// Act
		AccountVM? result = await _accountClient.GetAccountByIdAsync(account.Id!.Value);
	...
	public async Task GetAccountById_ShouldThrowHttpRequestExceptionOnNonSuccessStatusCode(HttpStatusCode statusCode)
	{
		...
		// Act & Assert
		await Assert.ThrowsAsync<HttpRequestException>(() => _accountClient.GetAccountByIdAsync(Guid.NewGuid()));
	}
	...
	public async Task GetAllAccounts_ShouldReturnAllAccounts()
	{
		...
		// Act
		List<AccountVM>? result = await _accountClient.GetAllAccountsAsync();
	...
	public async Task GetAllAccounts_ShouldThrowHttpRequestExceptionOnNonSuccessStatusCode(HttpStatusCode statusCode)
	{
		...
		// Act & Assert
		await Assert.ThrowsAsync<HttpRequestException>(() => _accountClient.GetAllAccountsAsync());
	}
	...
	public async Task UpdateAccounts_ShouldReturnTrueOnSuccess()
	{
		...
		// Act
		bool result = await _accountClient.UpdateAccountsAsync(accounts);
	...
	public async Task UpdateAccounts_ShouldThrowHttpRequestExceptionOnNonSuccessStatusCode(HttpStatusCode statusCode)
	{
		...
		// Act & Assert
		await Assert.ThrowsAsync<HttpRequestException>(() => _accountClient.UpdateAccountsAsync(accounts));
	}
	...
	public async Task DeleteAccounts_ShouldReturnTrueOnSuccess()
	{
		...
		// Act
		bool result = await _accountClient.DeleteAccountsAsync(ids);
	...
	public async Task DeleteAccounts_ShouldThrowHttpRequestExceptionOnNonSuccessStatusCode(HttpStatusCode statusCode)
	{
		...
		// Act & Assert
		await Assert.ThrowsAsync<HttpRequestException>(() => _accountClient.DeleteAccountsAsync(ids));
	}
}
