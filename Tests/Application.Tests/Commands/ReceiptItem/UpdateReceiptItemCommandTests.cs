...
public class UpdateReceiptItemCommandTests : ICommandTests<Domain.Core.ReceiptItem>
{
	public List<Domain.Core.ReceiptItem> GenerateItemsForTest()
	{
		return
		[
			new(Guid.NewGuid(), Guid.NewGuid(), "Item 1", "Description 1", 1, new Money(10), new Money(10), "Category 1", "Subcategory 1"),
			new(Guid.NewGuid(), Guid.NewGuid(), "Item 2", "Description 2", 2, new Money(2), new Money(4), "Category 2", "Subcategory 2")
		];
	}
