...
export function GlobalSearchDialog({
  ...
  const { data: receiptItemsData } = useReceiptItems();
  const { data: transactionsData } = useTransactions();

  const accounts = accountsData?.data as AccountResponse[] | undefined;
  const receipts = receiptsData?.data as ReceiptResponse[] | undefined;
  const receiptItems = receiptItemsData?.data as ReceiptItemResponse[] | undefined;
  const transactions = transactionsData?.data as TransactionResponse[] | undefined;
