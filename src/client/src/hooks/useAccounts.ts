...
export function useDeletedAccounts(offset = 0, limit = 50, sortBy?: string | null, sortDirection?: string | null) {
  return useQuery({
    queryKey: ["accounts", "deleted", offset, limit, sortBy, sortDirection],
    queryFn: async () => {
