...
public class UpdateTransactionBatchCommandHandler(
	ITransactionService transactionService,
	IReceiptService receiptService,
	IReceiptItemService receiptItemService,
	IAdjustmentService adjustmentService) : IRequestHandler<UpdateTransactionBatchCommand, bool>
{
	public async Task<bool> Handle(UpdateTransactionBatchCommand request, CancellationToken cancellationToken)
	{
